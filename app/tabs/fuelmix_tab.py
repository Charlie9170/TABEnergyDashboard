...
from utils.colors import get_fuel_color_hex, is_renewable  # noqa: E402
...
def render():
    ...
    # Local styles for a clean TAB-branded hero and consistent styling
    st.markdown(
        """
        <style>
            .fuelmix-hero .accent-bar {
                height: 6px;
                width: 140px;
    ...
    try:
        ...
        with col1:
            ...
            <div class="metric-card">
                ...
                <div class="metric-card-subtitle">Electricity Generation Rate</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with col2:
            ...
            <div class="metric-card">
                ...
                <div class="metric-card-subtitle">Solar + Wind Generation</div>
            </div>
            """, unsafe_allow_html=True)
    ...
    # Create stacked area chart with Plotly
        ...
        # Update layout - using global tab_theme from main.py - COMPACT HEIGHT
        fig.update_layout(
